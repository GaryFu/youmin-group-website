...
import { Building2, Target, Eye, Heart, Handshake, Phone } from 'lucide-react'
    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-green-800 to-green-900 pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-white mb-4">{aboutContent.title}</h1>
      ...
      <section className="py-16 bg-gradient-to-r from-green-800 to-green-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            <h2 className="text-3xl font-bold text-white mb-4">了解天佑集团</h2>
            <p className="text-green-200 text-lg mb-8">欢迎联系我们，了解更多集团信息与合作机会</p>
