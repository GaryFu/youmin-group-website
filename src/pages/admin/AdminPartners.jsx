            ...
            {cat.partners.length === 0 ? (
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {cat.partners.map((partner, pi) => (
                  <div key={`p-${ci}-${pi}`} className="relative group rounded-xl p-4 border border-gray-100 hover:border-green-200 transition-all">
                    ...
                    <div className="flex flex-col items-center text-center">
                      {partner.logo ? (
                        <img src={partner.logo} alt={partner.name} className="h-10 mb-2 object-contain mx-auto" />
                      ) : (
